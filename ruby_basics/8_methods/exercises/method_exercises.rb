...
def common_sports( current_sports , favorite_sports)
  r_array = current_sports.intersection(favorite_sports)
  r_array
end
...
def ascii_code(character)
  ...
  character.ord 
  #
  # The above code does not work for the empty string ('') it thinks that is receiving a 
  # valid input and bugs out.
  #  
  # if character.empty? || character.length != 1
  #     return 'Input Error'
  # else  
  #   character.ord 
  # end
